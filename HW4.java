...
public class HW4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Сортировка по возразту: ");
        sortByAgeAndPrint();
        System.out.println();
    ...
    private static boolean shouldStop(Scanner sc) {
            System.out.println("Введите \"стоп\" для окончания ввода данных или любое другое ЗНАЧЕНИЕ для продолжения: ");
            String cont = sc.nextLine();
        return cont.equalsIgnoreCase("стоп");
    }
    ...
    private static String getAge(Scanner sc) {
        while (true) {
            System.out.println("Введите возраст (0-200): ");
